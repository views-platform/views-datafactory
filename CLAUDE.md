...
- Not all paths traverse all layers. Synthetic data reaches consumers directly (skips consolidation, viewpoint, and compilation). GHS-POP and GHS-BUILT-S skip consolidation (single releases; ADR-029, ADR-034).
