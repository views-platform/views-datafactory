...
- `reports/rd_roadmap08.md` — R&D roadmap (ACLED Phase 0 complete, next: training integration + ACLED Phase 2)
- `reports/product_development_plan08.md` — Product plan with v1.0/v1.1/v1.2/v2.0 gate criteria
