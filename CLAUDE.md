...
- `reports/rd_roadmap07.md` — R&D roadmap (consumer parity achieved, next: training integration)
- `reports/product_development_plan06.md` — Product plan with v1.0/v1.1/v1.2/v2.0 gate criteria
