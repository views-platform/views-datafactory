...
**Status:** 317 concern IDs assigned (C-28 merged into C-31, C-107 merged into C-60, C-183 merged into C-44, C-44 merged into C-164, C-03 merged into C-176): 286 resolved, 28 open concerns (0 Tier 1, 1 Tier 2, 7 Tier 3, 14 Tier 4, 6 deferred by design; 3 with fired trigger), 8 open disagreements. 167 resolved concerns as full entries + 19 early-archive reference rows + 102 struck-through in active register (286 unique after dedup — 5 appear in both archive and active) + 32 resolved disagreements in archive. 41 disagreement IDs total: 33 resolved, 8 open.
...
| C-316 | 3 | Standalone writer scripts bypass the pipeline flock — manual export collided with cron assembly | Operator runs assemble/export/run_* manually while the monthly cron is active (FIRED 2026-07-21) | Pipeline safety |
| C-317 | 3 | SIGKILL bypasses ERR+EXIT traps — no failure ping, no status page on OOM kill | Pipeline process OOM-killed during assembly/export (near-miss 2026-07-21: export at 95.9% RSS for 9h) | Operational monitoring |
