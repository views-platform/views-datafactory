...
| C-314 | 2 | ACLED January 2026 fatality sum 3-4x typical — unverified anomaly served to consumers | Before the next model training run that consumes ACLED 2026 months (#320) | Data soundness |
