...
**Status:** 295 concern IDs assigned (C-28 merged into C-31, C-107 merged into C-60, C-183 merged into C-44, C-44 merged into C-164, C-03 merged into C-176): 236 resolved, 56 open concerns (0 Tier 1, 5 Tier 2, 13 Tier 3, 32 Tier 4, 6 deferred by design; 2 with fired trigger), 8 open disagreements. 167 resolved concerns as full entries + 19 early-archive reference rows + 53 struck-through in active register (236 unique after dedup — 3 appear in both archive and active) + 31 resolved disagreements in archive. 39 disagreement IDs total: 31 resolved, 8 open.
