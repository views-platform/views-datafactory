...
Data variables:
    ...
    acled_count        (time, lat, lon) float32 ...
    acled_battles      (time, lat, lon) float32 ...
    acled_explosions   (time, lat, lon) float32 ...
    acled_vac          (time, lat, lon) float32 ...
    acled_protests     (time, lat, lon) float32 ...
    acled_riots        (time, lat, lon) float32 ...
    acled_strategic    (time, lat, lon) float32 ...
    acled_fatalities   (time, lat, lon) float32 ...
