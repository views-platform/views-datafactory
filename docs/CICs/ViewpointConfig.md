...
- `gaul1_crosswalk_path`: Path, GAUL admin-1 crosswalk for spatial distribution (default: `data/raw/gaul_admin_area_majority/gaul1_code.parquet`)
- `gaul0_crosswalk_path`: Path, GAUL country crosswalk for spatial distribution (default: `data/raw/gaul_admin_area_majority/gaul0_code.parquet`)
