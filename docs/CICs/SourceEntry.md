...
- **Green:** Valid construction, frozen enforcement, None slo allowed, feature count is 75, canonical feature order (UCDP first, GHS-POP after ACLED, GHS-BUILT-S after GHS-POP, V-Dem after GHS-BUILT-S, admin last)
